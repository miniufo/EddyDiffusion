...
public final class OSCARPSA{
	...
	private static final int len=720;
	...
	private static final String path="d:/Data/OSCAR/Synthetic/";
	
	
	//
	public static void main(String[] args){
		DiagnosisFactory df=DiagnosisFactory.parseFile(path+"oscarDaily.ctl");
		...
		for(int r=0;r<regions.length;r++){
			...
			Variable u=df.getVariables(new Range(area+";t(1,"+len+")",dd),"u")[0];
			Variable v=df.getVariables(new Range(area+";t(1,"+len+")",dd),"v")[0];
