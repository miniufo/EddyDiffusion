...
public class CoeffDavis{
	...
	static void postProcess(List<GDPDrifter> ls){
		...
		SingleParticleStatResult r1=lstat.cStatisticsByDavisTheory(r->regions[0].inRange(r.getXPos(),r.getYPos()), 60);
		SingleParticleStatResult r2=lstat.cStatisticsByDavisTheory(r->regions[1].inRange(r.getXPos(),r.getYPos()), 60);
		SingleParticleStatResult r3=lstat.cStatisticsByDavisTheory(r->regions[2].inRange(r.getXPos(),r.getYPos()), 60);
		SingleParticleStatResult r4=lstat.cStatisticsByDavisTheory(r->regions[3].inRange(r.getXPos(),r.getYPos()), 60);
		SingleParticleStatResult r5=lstat.cStatisticsByDavisTheory(r->regions[4].inRange(r.getXPos(),r.getYPos()), 60);
		SingleParticleStatResult r6=lstat.cStatisticsByDavisTheory(r->regions[5].inRange(r.getXPos(),r.getYPos()), 60);
		SingleParticleStatResult r7=lstat.cStatisticsByDavisTheory(r->regions[6].inRange(r.getXPos(),r.getYPos()), 60);
